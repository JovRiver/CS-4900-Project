...
let theMixer, mixEvent = true;// = new THREE.AnimationMixer();
...
function renderFrame(){
	...
	//animation functions for catGun here
	if(theMixer) {//null would be false; move eventListener to the event function after
		//we find a way to load the listener after the mixer's loaded? doesn't load the listener while it's in the eventListener function
...
function setupEventHandlers(){
	...
	//		theMixer.addEventListener('finished', animationFinish);
}
