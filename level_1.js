    ...
    function object_Loader(){//https://threejs.org/docs/#examples/en/loaders/OBJLoader
        ...
        catLoader.load(
            ...
            function(obj) {//onLoad, obj is a GLTF
                ...
                obj.scene.position.y = 121;
                obj.scene.position.x = -16;
                obj.scene.position.z = 16;
               ...
               /* anims.forEach(function(aClip){//this plays them all, but the animations might be merged together.
                    theMixer.clipAction(aClip).play();//returns an Animation Action that's played with play()
                });*/
                theMixer.clipAction(anims[0]).play();//"death" doesn't play for some reason, index 1?
